...
public struct Secured<Value: Codable> {
    ...
    private let accessibleAttribute: CFString?
    ...
    private var searchQuery: [String: Any] {
        ...
        if let accessibleAttribute {
            query[kSecAttrAccessible as String] = accessibleAttribute
        }
    ...
    public init(key: String, accessGroup: String? = nil, accessibleAttribute: CFString? = nil, keychain: KeychainProtocol = Keychain.default) {
        self.key = key
    ...
    public init(key: String, accessGroup: String? = nil, accessibleAttribute: CFString? = nil, keychain: KeychainProtocol = Keychain.default, defaultValue: Value?) {
        self.key = key
        self.keychain = keychain
        self.accessGroup = accessGroup
        self.accessibleAttribute = accessibleAttribute
